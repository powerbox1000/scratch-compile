...
The Scratch Compiler "converts" Scratch 3.0 projects to an HTML file by putting all the project data and the entire Scratch engine into one enormous file.
...
A new update will soon add the ability to inject HTML elements. (This will be censored)
...
Original code by [sheeptester](https://github.com/sheeptester)'s [HTMLIfier](https://sheeptester.github.io/htmlifier)
